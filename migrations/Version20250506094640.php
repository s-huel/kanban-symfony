 ...
 */
final class Version20250506094640 extends AbstractMigration
{
    ...
    {
        // Commenting out the addition of the `id` column because it already exists
        // $this->addSql(<<<'SQL'
        //     ALTER TABLE tag_task ADD id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)
        // SQL);

        // Commenting out the addition of the foreign key constraint because it already exists
        // $this->addSql(<<<'SQL'
        //     ALTER TABLE task ADD CONSTRAINT FK_527EDB25497B19F9 FOREIGN KEY (priority_id) REFERENCES priority (id)
        // SQL);

        // Commenting out the creation of the index because it already exists
        // $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        // Commenting out the removal of the foreign key constraint
        // $this->addSql(<<<'SQL'
        //     ALTER TABLE task DROP FOREIGN KEY FK_527EDB25497B19F9
        // SQL);

        // Commenting out the removal of the index
        // $this->addSql(<<<'SQL'
